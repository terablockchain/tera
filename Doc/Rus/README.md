...
Это публичный блокчейн главной особенностью которого является истинная децентрализация за счет использования консенсуса pow и очень быстрая скорость работы.
